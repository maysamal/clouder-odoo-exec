...
RUN sudo pip install simplejson lxml pytz psycopg2 werkzeug pyyaml mako platypus unittest2 reportlab decorator pillow requests 
RUN sudo pip install jinja2 pyPdf passlib psutil
RUN sudo apt-get install python-dateutil python-pychart python-decorator python-docutils python-passlib python-openid python-babel
